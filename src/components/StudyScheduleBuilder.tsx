export default function StudyScheduleBuilder() {
  ...
  return (
    ...
    >
      <div className={`rounded-xl shadow-lg p-6 max-w-2xl w-full mx-auto ${boxClasses}`}>
        ...
        <button className="mt-4 bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-4 rounded-lg transition">
          Generate Schedule
        </button>
      </div>
    </div>
