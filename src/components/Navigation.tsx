...
export default function Navigation({ currentView, onViewChange, userStats }: NavigationProps) {
  ...
  return (
    <nav className={`${navClasses} shadow-sm border-b transition-all duration-500 z-50 flex-shrink-0 fixed top-0 left-0 right-0`} style={{ backgroundColor: 'red', height: '64px' }}>
