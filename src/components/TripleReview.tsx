    ...
    <div className="fixed inset-0 flex flex-col bg-slate-50 z-40">
      ...
      <div ref={mainContentRef} className="flex-1 p-6 overflow-y-auto">
        ...
        {showCircuitBuilder && session.phase !== 'timed' ? (
          ...
          <div className={session.phase === 'timed' ? "grid lg:grid-cols-3 gap-6 h-full" : "grid lg:grid-cols-4 gap-6 h-full"}>
            {/* Left Column: Passage */}
            <div className="lg:col-span-1 space-y-6 h-full overflow-y-auto">
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                <div className="prose max-w-none">
            ...
            <div className={session.phase === 'timed' ? "lg:col-span-2 space-y-6 h-full overflow-y-auto" : "lg:col-span-2 space-y-6 h-full overflow-y-auto"}>
