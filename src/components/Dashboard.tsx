...
const Dashboard: React.FC<DashboardProps> = ({ 
  ...
  return (
    <div className={`h-screen w-full flex flex-col transition-all duration-500 ${backgroundClasses}`}>
      <div className="flex-1 overflow-hidden">
        <div className="h-full p-4 lg:p-6">
          <div className="max-w-7xl mx-auto h-full flex flex-col space-y-4 lg:space-y-6">
        
            {/* Welcome Header - Fixed height on desktop */}
            <div className="flex-shrink-0">
              <Card padding="lg" gradient={theme === 'light'}>
                <div className={`${theme === 'dark' ? 'bg-gradient-to-r from-blue-600/20 via-purple-600/20 to-teal-600/20 p-6 lg:p-8 -m-6 lg:-m-8 rounded-3xl' : ''}`}>
                  <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between">
                    <div className="mb-4 lg:mb-0">
                      <h1 className={`text-2xl lg:text-4xl xl:text-5xl font-bold mb-2 lg:mb-3 ${
                        theme === 'dark' 
                          ? 'text-white' 
                      ...
                      <p className={`text-lg lg:text-xl mb-3 lg:mb-4 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
                    ...
                    <div className="flex items-center space-x-4 lg:space-x-8">
                      <div className="text-center group cursor-pointer">
                        <div className={`text-2xl lg:text-4xl font-bold mb-1 transition-colors duration-300 ${
                          theme === 'dark' 
                        ...
                        <div className={`text-xs lg:text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>Circuits Built</div>
                      </div>
                      <div className="text-center group cursor-pointer">
                        <div className={`text-2xl lg:text-4xl font-bold mb-1 transition-colors duration-300 ${
                          theme === 'dark' 
                        ...
                        <div className={`text-xs lg:text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>Tests Completed</div>
                      </div>
                      <div className="text-center group cursor-pointer">
                        <div className={`text-2xl lg:text-4xl font-bold mb-1 transition-colors duration-300 ${
                          theme === 'dark' 
                        ...
                        <div className={`text-xs lg:text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>Analysis Score</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex-1 min-h-0 grid lg:grid-cols-3 gap-4 lg:gap-8">
                    ...
                    <CardContent className="space-y-3">
                      <div className={`flex items-center justify-between p-3 rounded-2xl border ${
                        ...
                        <div className="flex items-center">
                          <div className="w-7 h-7 bg-gradient-to-br from-yellow-400 to-yellow-500 text-gray-900 text-sm font-bold rounded-full flex items-center justify-center mr-3 shadow-lg">1</div>
                      ...
                      <div className={`flex items-center justify-between p-3 rounded-2xl border ${
                        ...
                        <div className="flex items-center">
                          <div className="w-7 h-7 bg-gradient-to-br from-gray-400 to-gray-500 text-white text-sm font-bold rounded-full flex items-center justify-center mr-3 shadow-lg">2</div>
                      ...
                      <div className={`flex items-center justify-between p-3 rounded-2xl border ${
                        ...
                        <div className="flex items-center">
                          <div className="w-7 h-7 bg-gradient-to-br from-orange-400 to-orange-500 text-gray-900 text-sm font-bold rounded-full flex items-center justify-center mr-3 shadow-lg">3</div>
                      ...
                      <div className={`flex items-center justify-between p-3 rounded-2xl border-2 ${
                        ...
                        <div className="flex items-center">
                          <div className="w-7 h-7 bg-gradient-to-br from-blue-500 to-purple-500 text-white text-sm font-bold rounded-full flex items-center justify-center mr-3 shadow-lg">{user.stats.rank}</div>
                  ...
                  <Card padding="default">
                    ...
                    <CardContent>
                      <div className="text-center">
                        ...
                        <div className={`text-sm mb-4 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>Days in a row 🔥</div>
                        
                        <div className="grid grid-cols-7 gap-1">
                          {[...Array(7)].map((_, i) => (
                            <div 
                              key={i} 
                              className={`h-8 w-8 rounded-xl bg-gradient-to-br from-orange-500 to-red-500 shadow-lg transform hover:scale-110 transition-transform ${
