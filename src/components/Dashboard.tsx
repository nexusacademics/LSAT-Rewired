                ...
                <Card padding="default" className="h-full flex flex-col">
                  ...
                  <CardContent className="flex-1 flex flex-col justify-center min-h-0">
                    ...
                    <div className="grid grid-cols-2 gap-3 h-full min-h-0">
                      ...
                      <div className="flex flex-col justify-center space-y-2 min-h-0">
                        <div className="text-center">
                      ...
                      <div className="flex flex-col justify-center min-w-0 min-h-0">
                        <div className={`text-xs font-medium mb-1 text-center ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
                          Leaderboard
                        </div>
                        
                        <div className="space-y-1 min-w-0 overflow-hidden">
                          <div className={`flex items-center justify-between p-1 rounded border text-xs min-w-0 ${
