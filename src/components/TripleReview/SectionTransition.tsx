...
export const SectionTransition: React.FC<SectionTransitionProps> = ({
  ...
  }, [shouldShowCountdown, isAfterSection2, onConfirm]);
  ...
  const getTransitionTitle = (): string => {
    ...
    if (shouldShowCountdown && isIntermission) return 'Intermission';
    if (shouldShowCountdown) return 'Section Break';
  ...
  return (
    <div 
      ...
      onClick={(e) => {
        if (!triggeredByTimer && !shouldShowCountdown) {
          onCancel();
        }
        e.stopPropagation();
      }}
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-200">
          <div className="flex items-center gap-2">
            {shouldShowCountdown && <Clock size={20} className="text-blue-600" />}
        ...
        <div className="p-6">
          ...
          {shouldShowCountdown && !isIntermission && (
