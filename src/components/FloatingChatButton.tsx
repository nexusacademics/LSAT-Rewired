...
import AIChat from './AIChat'; // ✅ Replace ChatWindow with your actual chat UI
...
export default function FloatingChatButton() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className="fixed bottom-20 right-6 z-50 bg-white border border-slate-200 rounded-xl shadow-xl flex flex-col overflow-hidden"
          style={{ width, height }}
        >
